...
function love.load()
  ...
  local firstdialog = Talkies.say("NASA", "Hello, Curiosity! Welcome to Mars!--The goal of your mission:--collect all the minerals in this sector and take them to the hub to upgrade yourself.")
